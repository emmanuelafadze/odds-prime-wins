...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "German's premier football prediction platform offering Fixed daily tips and correct scores." },
    { property: "og:title", content: "About ODDSPrime" },
    { property: "og:description", content: "Why ODDSPrime is German's most trusted tipster." },
  ]}),
  component: () => (
    <SiteLayout>
