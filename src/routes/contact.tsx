    ...
    <SiteLayout>
      <section className="container mx-auto max-w-4xl px-4 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          <Card className="p-6"><MapPin className="h-6 w-6 text-primary" /><h3 className="mt-3 font-semibold">Location</h3><p className="mt-1 text-sm text-muted-foreground">Accra, Ghana</p></Card>
        </div>
      </section>
    </SiteLayout>
  ),
